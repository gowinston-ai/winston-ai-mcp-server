...
export class WinstonAiClient {
  ...
  public isApiKeyInvalid(): boolean {
    return (
      ...
      this.apiKey.toLowerCase().includes("api")
    );
  }
  ...
  public assembleTextCompareResponse(
    result: TextCompareResponse | IResponseError,
  ): string {
  ...
  public assemblePlagiarismResponse(
    r: PlagiarismDetectionResponse | IResponseError,
  ): string {
  ...
  public assembleAiImageDetectorResponse(
    result: AiImageDetectorResponse | IResponseError,
  ): string {
